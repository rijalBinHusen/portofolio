      ...
      <div class="container mx-auto mt-8 md:mt-0 md:space-x-10 md:grid grid-cols-3 justify-center md:py-40">
        <div class="grid justify-center items-center order-1 col-span-1">
          <img
            ...
            src="../assets/14441415832_86d55370be_o.jpg"
            alt=""
          >
        </div>
      ...
      >
        ...
        >
          <div>
            ...
            <div v-else>
              <div 
                class="bg-blue-100 animate-pulse bg-opacity-50 rounded mb-2"
                style="height:35px; background: rgba(140,226,255,1) 39%;"
              >
                <p />
              </div>
              <div 
...
export default {
    ...
    methods: {
        getWeather(city) {
            ...
            .catch( (error) => this.weather = { name: "Not Found", sys: { country: ""}, main: {temp: ""}, weather: [ {description: ""} ] })
            this.city = city
        }
    },
}
